...
<script>
    const statItems = [
        ...
        { key: 'totalTrainers', label: 'Antrenör', className: 'bg-success' },
        { key: 'totalClasses', label: 'Ders', className: 'bg-info' },
        { key: 'totalEquipment', label: 'Ekipman', className: 'bg-secondary' },
            ...
            row.innerHTML = `
                <div class="col-12">
                    <div class="alert alert-danger mb-0">
                        Dashboard yüklenemedi: ${escapeHtml(error.message)}
                    </div>
                </div>
            `;
        }
